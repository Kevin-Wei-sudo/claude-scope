...
final class UsageIntelligenceService: ObservableObject {
    ...
    func refresh(
        ...
        guard intelligenceEnabled, predictionEnabled, let usage else {
            snapshot = nil
            return
        }
        ...
        let fiveHourProjection = projectLimitRisk(
            ...
            LimitProjection(
                ...
                secondsUntilHighRisk: $0.secondsUntilHighRisk,
                safeAdditionalPct: $0.safeAdditionalPct
            )
        }
        ...
        let summary = buildIntelligenceSummary(
            fiveHour: fiveHourProjection,
            sevenDay: sevenDayProjection,
